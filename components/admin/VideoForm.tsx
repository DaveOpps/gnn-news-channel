        ...
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            {isEdit
              ...
              : "Paste a YouTube link to add a video to GNN TV."}
          </p>
        </div>
        <Link
          href="/admin/videos"
      ...
      <Card className="space-y-5 p-6">
        ...
        <div>
          ...
          <input
            ...
            required
            placeholder="e.g. GNN News at 7 — Full Bulletin"
        ...
        <label className="flex cursor-pointer select-none items-start gap-3 rounded-lg border border-zinc-200 p-4 transition-colors hover:bg-zinc-50/70">
          ...
          <span>
            ...
            <span className="block text-xs text-zinc-500">
              Shown as the hero video at the top of the GNN TV hub.
            </span>
          </span>
        </label>
      </Card>
